...
import typer
from pymarkable import __version__
from pymarkable.example import hello
...
app = typer.Typer(
    name="pymarkable",
    help="Python project with scritps and utilities for use with remarkable readers",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]pymarkable[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the pymarkable package.",
    ),
):
